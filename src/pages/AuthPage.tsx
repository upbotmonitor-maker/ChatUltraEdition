        ...
        <div className="bg-card border border-card-border rounded-2xl shadow-md overflow-hidden">
          <div className="flex border-b border-border">
            <button
              ...
              className={`flex-1 py-3.5 text-sm font-semibold transition-colors ${tab === "login" ? "text-primary border-b-2 border-primary bg-accent/30" : "text-muted-foreground hover:text-foreground"}`}
            >
              Giriş Yap
            </button>
            <button
              ...
              className={`flex-1 py-3.5 text-sm font-semibold transition-colors ${tab === "register" ? "text-primary border-b-2 border-primary bg-accent/30" : "text-muted-foreground hover:text-foreground"}`}
            >
              Kayıt Ol
            </button>
          </div>
