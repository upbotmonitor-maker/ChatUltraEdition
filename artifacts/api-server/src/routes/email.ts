    ...
    await client.transactionalEmails.sendTransacEmail({
      ...
      htmlContent: `
        <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #1a1a2e; color: #ffffff; border-radius: 12px;">
          ...
          <p style="color: #aaaaaa; margin-bottom: 24px;">Doğrulama kodunuz:</p>
          ...
          <p style="color: #aaaaaa; font-size: 13px;">Bu kod 10 dakika geçerlidir. Eğer bu isteği siz yapmadıysanız, bu e-postayı dikkate almayın.</p>
